#This does the same thing as the distance plot, except it doesnt plot the values, it just returns
#a vector with all the distance values in it for a given nucleus
